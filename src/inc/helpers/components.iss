...
begin
  ...
  try
    Buffer.Add('// =============================================================================');
    Buffer.Add('//  ____                         _____  ____   _____');
    Buffer.Add('// |    .  ___  ___  ___  _____ |   __||    . |  |  |');
    Buffer.Add('// |  |  ||  _|| -_|| .''||     ||__   ||  |  ||    -|');
    Buffer.Add('// |____/ |_|  |___||__,||_|_|_||_____||____/ |__|__|');
    Buffer.Add('//');
    Buffer.Add('// =============================================================================');
    Buffer.Add('// DreamSDK Setup - Embedded Components List');
    Buffer.Add('// =============================================================================');
    Buffer.Add('//');
    Buffer.Add(Format('// THIS FILE HAS BEEN GENERATED ON %s.', [GetDateTimeString('yyyy-mm-dd hh:nn:ss', '-', ':')]));
    Buffer.Add('// PLEASE DON''T UPDATE IT.');
    Buffer.Add('');
    Buffer.Add('[Code]');
    Buffer.Add('{ This code has been generated by SaveComponentsListName directly by Inno Setup.');
    Buffer.Add('  To regenerate it, delete this file and run the Setup in DEBUG mode again or');
    Buffer.Add('  use the "tools/components" utility. }');
    Buffer.Add('');
    Buffer.Add('procedure InitializeComponentsListName();');
    Buffer.Add('begin');
    Buffer.Add('  Log(''InitializeComponentsListName called'');');
    ...
    Buffer.Add('  Log(''InitializeComponentsListName ended'');');
    Buffer.Add('end;');
...
begin
  ...
  begin
    ...
    begin
      ...
      if DirExists('{#GENERATED_COMPONENTS_LIST_PATH}') then
      begin
        Log(Format('Generating "%s"...', ['{#GENERATED_COMPONENTS_LIST_FILE}']));
        SaveComponentsListName('{#GENERATED_COMPONENTS_LIST_PATH}/{#GENERATED_COMPONENTS_LIST_FILE}');
      end
      else
        Log(Format('Unable to generate %s, directory not found: "%s"', [
          '{#GENERATED_COMPONENTS_LIST_FILE}',
          '{#GENERATED_COMPONENTS_LIST_PATH}'
        ]));
    end;
#endif
